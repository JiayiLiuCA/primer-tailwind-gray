  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl pt-16 sm:px-6">
        <div className="bg-gray-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-gray-900 sm:text-6xl">
              <span className="block text-gray-600">Mira Lindehoff –</span> Hey
            ...
            <p className="mt-8">
              <Link
                href="#"
                className="inline-flex items-center text-base font-medium tracking-tight text-gray-900"
              >
