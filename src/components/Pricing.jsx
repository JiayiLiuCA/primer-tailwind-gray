        ...
        <p className="order-first flex font-display font-bold">
          <span
            className={clsx(
              ...
              featured ? 'text-gray-200' : 'text-gray-500',
            )}
          >
            $
          </span>
            ...
            {features.map((feature) => (
              <li key={feature} className="flex py-2">
                <CheckIcon
                  className={clsx(
                    'h-8 w-8 flex-none',
                    featured ? 'fill-white' : 'fill-gray-600',
                  )}
                />
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto mt-16 max-w-5xl lg:px-6">
        <div className="grid bg-gray-50 sm:px-6 sm:pb-16 md:grid-cols-2 md:rounded-6xl md:px-8 md:pt-16 lg:p-20">
          <Plan
            name="Essential"
